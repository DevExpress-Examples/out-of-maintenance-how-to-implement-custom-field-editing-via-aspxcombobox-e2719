...
public partial class AppointmentForm : SchedulerFormControl
{
    ...
    public override void DataBind()
    {
        ...
        edtLabel.SelectedIndex = container.Control.Storage.Appointments.Labels.FindIndex(lb => (int)lb.Id == (int)apt.LabelKey);
        edtStatus.SelectedIndex = container.Control.Storage.Appointments.Statuses.FindIndex(st => (int)st.Id == (int)apt.StatusKey);
